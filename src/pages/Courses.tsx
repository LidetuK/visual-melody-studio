    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-grow">
        ...
        <section className="bg-gradient-to-b from-gray-100 to-white py-20 px-4 sm:px-6 lg:px-8">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-700 max-w-3xl mx-auto animate-fade-in animation-delay-100">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
          <div className="container mx-auto max-w-7xl">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-12 text-center">Available Courses</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {courses.map((course, index) => (
                <Card 
                  key={course.slug} 
                  className={`bg-white border border-gray-200 hover:border-elfign-red/50 transition-all duration-300 animate-fade-in overflow-hidden shadow-sm`}
                ...
                >
                  ...
                  <CardContent>
                    <p className="text-sm text-gray-700 line-clamp-3">{course.shortDescription}</p>
                  </CardContent>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-100">
          <div className="container mx-auto max-w-5xl text-center">
            <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-6">Ready to Elevate Your Skills?</h2>
